...
OAuth setup, GCP project configuration, and the brand-account picker step are covered in [`INSTALL.md`](INSTALL.md). Read it before the first `youtube-complete-mcp auth add`.
